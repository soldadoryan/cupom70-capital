...
export const metadata: Metadata = {
  title: "Capital City | Pack Veículos 3",
};

const items = [
  { icon: <FaCar />, label: "Nissan S15", value: "30 dias" },
  { icon: <FaCar />, label: "BMW M5", value: "30 dias" },
  { icon: <FaCar />, label: "Ford Mustang", value: "30 dias" },
];

export default function PackVeiculos3() {
  return (
    <>
      <PageStructure>
        <Container customClass={s.customContainer}>
          <main className={s.main}>
            ...
            <h2 className={s.title}>
              <span>Pack Veículos 3</span>
            </h2>
            <p>
              Japonês, alemão e americano. Três ícones de estilos diferentes pra
              você escolher com qual sair a cada dia.
            </p>
            ...
            <ul className={s.items}>
              <li className={`${s.item} ${s.featured}`}>
                ...
                <div className={s.itemText}>
                  ...
                  <span className={s.itemValue}>3 veículos VIP por 30 dias</span>
                </div>
              </li>
              {items.map((item) => (
